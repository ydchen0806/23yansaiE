...
class mRSDataset(Dataset):
  # 自定义Dataset类加载数据
    ...
    def __init__(self, prase = 'train', scale_data = False, split_rate = 0.7, use_pca = True):
        ...
        table1 = pd.read_excel(r'E:\外包作业\23研赛\建模2023\建模2023\2023年中国研究生数学建模竞赛赛题\E题\E题\数据\竞赛发布数据\表1-患者列表及临床信息.xlsx') 
        table2 = pd.read_excel(r'E:\外包作业\23研赛\建模2023\建模2023\2023年中国研究生数学建模竞赛赛题\E题\E题\处理后的表2.xlsx')
        table3_ED = pd.read_excel(r'E:\外包作业\23研赛\建模2023\建模2023\2023年中国研究生数学建模竞赛赛题\E题\E题\数据\竞赛发布数据\表3-患者影像信息血肿及水肿的形状及灰度分布.xlsx', \
                               sheet_name='ED')
        table3_hemo = pd.read_excel(r'E:\外包作业\23研赛\建模2023\建模2023\2023年中国研究生数学建模竞赛赛题\E题\E题\数据\竞赛发布数据\表3-患者影像信息血肿及水肿的形状及灰度分布.xlsx', \
                               sheet_name='Hemo')
        self.table1 = table1
        self.table2 = table2
